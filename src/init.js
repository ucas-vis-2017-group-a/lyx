document.addEventListener("DOMContentLoaded", function () {
    ...
    function inject(filename) {
        // should change into creating iframe approach in this method
    ...
    function remove_injected() {
        ...
        // remove failed
        // changes referrs the inject function!
        // remove script -- hard to accomplish --> dynamic changes in iframe -- easier?
